...
<html>
  <head>
    ...
    <title><?php include('../dist/includes/title.php');?> | Skill</title>
...
include('../dist/includes/dbcon.php');
    ...
    $query=mysqli_query($con,"select * from skill order by skill")or die(mysqli_error());
...
<div id="update<?php echo $id;?>" class="modal modal-primary fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal" method="post" action="skill_update.php" enctype='multipart/form-data'>
          <input type="hidden" class="form-control" name="id" value="<?php echo $id;?>">  
          <div class="form-group">
            <label class="control-label col-lg-3" for="last">Skill</label>
            <div class="col-lg-8">
              <input type="text" class="form-control" id="last" name="skill" placeholder="skill" value="<?php echo $skill;?>">  
            </div>
          </div> <br>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal" method="post" action="">
          ...
          <p>Are you sure you want to delete <?php echo $skill;?>?</p> 
...
<?php }?>                     
    ...
    <div class="modal-dialog">
      <div class="modal-content">
                      ...
                      <div class="modal-body">
                       <form class="form-horizontal" method="post" action="skill_save.php" enctype='multipart/form-data'>
                          <!-- Title -->
                          <div class="form-group">
                            <label class="control-label col-lg-3" for="last">Skill</label>
                            <div class="col-lg-8">
                              <input type="text" class="form-control" id="last" name="skill" placeholder="Enter Skill here...">  
                            </div>
                          </div> 
                      </div>     
                      <!--end of modal body-->
...
<?php
  ...
  // sending query
  mysqli_query($con,"delete from skill WHERE skill_id='$id'")
  or die(mysqli_error());
