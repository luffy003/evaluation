...
include('../dist/includes/dbcon.php');
		...
		$query=mysqli_query($con,"select * from department order by department_title")or die(mysqli_error());
...
<div id="update<?php echo $id;?>" class="modal modal-primary fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
		<div class="modal-dialog">
          ...
          <div class="form-group">
            <label class="control-label col-lg-3" for="first">Department</label>
            <div class="col-lg-8">
                <input type="hidden" class="form-control" id="first" name="id"  value="<?php echo $id;?>">  
                <input type="text" class="form-control" id="first" name="title" placeholder="Department"  value="<?php echo $title;?>">  
            </div>
          </div><br>
  	      <!-- Title -->
         <br>
		...
		<div class="modal-dialog">
		  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          ...
                          <!-- Title -->
                          <div class="form-group">
                  				  <label class="control-label col-lg-3" for="last">Department Name</label>
                  				  <div class="col-lg-8">
                              <input type="text" class="form-control" id="last" name="dept" placeholder="Department Name">  
                      		  </div>
                          </div> 
