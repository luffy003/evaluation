...
<html>
  <head>
    ...
    <title><?php include('../dist/includes/title.php');?> | Language</title>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <a class="btn btn-block btn-primary" data-target="#addcat" class="btn btn-primary" data-toggle="modal" rel="tooltip" title="Update">Add Language</a>
            </span>
          </h1>
          <ol class="breadcrumb">
...
include('../dist/includes/dbcon.php');
    ...
    $query=mysqli_query($con,"select * from language order by language")or die(mysqli_error());
...
<div id="update<?php echo $id;?>" class="modal modal-primary fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal" method="post" action="language_update.php" enctype='multipart/form-data'>
          <input type="hidden" class="form-control" name="id" value="<?php echo $id;?>">  
          <div class="form-group">
            <label class="control-label col-lg-3" for="last">Language</label>
            <div class="col-lg-8">
              <input type="text" class="form-control" id="last" name="language" placeholder="Language" value="<?php echo $language;?>">  
            </div>
          </div> <br>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal" method="post" action="">
          ...
          <p>Are you sure you want to delete <?php echo $language;?>?</p> 
...
<?php }?>                     
    ...
    <div class="modal-dialog">
      <div class="modal-content">
                      ...
                      <div class="modal-body">
                       <form class="form-horizontal" method="post" action="language_save.php" enctype='multipart/form-data'>
                          <!-- Title -->
                          <div class="form-group">
                            <label class="control-label col-lg-3" for="last">Language</label>
                            <div class="col-lg-8">
                              <input type="text" class="form-control" id="last" name="language" placeholder="Enter Language here...">  
                            </div>
                          </div> 
                      </div>     
                      <!--end of modal body-->
...
<?php
  ...
  // sending query
  mysqli_query($con,"delete from language WHERE lang_id='$id'")
  or die(mysqli_error());
