...
<html>
  <head>
    ...
    <title><?php include('../dist/includes/title.php');?> | Announcements</title>
...
<div id="update<?php echo $id;?>" class="modal modal-primary fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form class="form-horizontal" method="post" action="announcement_update.php" enctype='multipart/form-data'>
          <input type="hidden" class="form-control" name="id" value="<?php echo $id;?>">  
          <div class="form-group">
            <label class="control-label col-lg-3" for="last">Announcement</label>
            <div class="col-lg-8">
              <textarea class="form-control" rows="5" name="announcement" placeholder="Enter Announcement here ..." required><?php echo $announcement;?></textarea>
            </div>
          </div> <br><br><br><br><br>
...
<?php }?>                     
    ...
    <div class="modal-dialog">
      <div class="modal-content">
                      ...
                      <div class="modal-body">
                       <form class="form-horizontal" method="post" action="announcement_save.php" enctype='multipart/form-data'>
                          <!-- Title -->
                          <div class="form-group">
                            <label class="control-label col-lg-3" for="last">Announcement</label>
                            <div class="col-lg-8">
                              <textarea class="form-control" rows="3" name="announcement" placeholder="Enter Announcement here ..." required></textarea>
                            </div>
                          </div> 
